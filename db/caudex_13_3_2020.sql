...
-- Dumping structure for table caudex.tec_brand
...
-- Dumping structure for table caudex.tec_categories
...
-- Dumping structure for table caudex.tec_combo_items
...
-- Dumping structure for table caudex.tec_counter
...
-- Dumping structure for table caudex.tec_country
CREATE TABLE IF NOT EXISTS `tec_country` (
...
-- Dumping structure for table caudex.tec_customers
...
-- Dumping structure for table caudex.tec_estimate_items
...
-- Dumping structure for table caudex.tec_estimate_sales
...
-- Dumping structure for table caudex.tec_expenses
...
-- Dumping structure for table caudex.tec_gift_cards
...
-- Dumping structure for table caudex.tec_groups
...
-- Dumping structure for table caudex.tec_gst_groups
...
-- Dumping structure for table caudex.tec_items_returns
CREATE TABLE IF NOT EXISTS `tec_items_returns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping structure for table caudex.tec_login_attempts
...
-- Dumping structure for table caudex.tec_payments
CREATE TABLE IF NOT EXISTS `tec_payments` (
  ...
  `store_id` int(11) NOT NULL DEFAULT '1',
  `cash_amount` varchar(100) NOT NULL DEFAULT '0',
  `card_amount` varchar(100) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8;

-- Data exporting was unselected.

-- Dumping structure for table caudex.tec_payments_returns
...
-- Dumping structure for table caudex.tec_printers
...
-- Dumping structure for table caudex.tec_products
CREATE TABLE IF NOT EXISTS `tec_products` (
  ...
  `pkg_qty` decimal(15,4) DEFAULT '0.0000',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47129 DEFAULT CHARSET=utf8;

-- Data exporting was unselected.

-- Dumping structure for table caudex.tec_product_store_qty
...
-- Dumping structure for table caudex.tec_purchases
...
-- Dumping structure for table caudex.tec_purchases_return
CREATE TABLE IF NOT EXISTS `tec_purchases_return` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping structure for table caudex.tec_purchase_items
...
-- Dumping structure for table caudex.tec_purchase_items_return
CREATE TABLE IF NOT EXISTS `tec_purchase_items_return` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping structure for table caudex.tec_registers
...
-- Dumping structure for table caudex.tec_register_sales
...
-- Dumping structure for table caudex.tec_sales
CREATE TABLE IF NOT EXISTS `tec_sales` (
  ...
  `cash_amount` varchar(100) NOT NULL DEFAULT '0',
  `card_amount` varchar(100) NOT NULL DEFAULT '0',
  `cheque_amount` varchar(100) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8;

-- Data exporting was unselected.

-- Dumping structure for table caudex.tec_sales_returns
...
-- Dumping structure for table caudex.tec_sale_items
...
-- Dumping structure for table caudex.tec_sale_items_returns
CREATE TABLE IF NOT EXISTS `tec_sale_items_returns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `return_sale_id` int(11) NOT NULL,
  `sale_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `quantity` decimal(15,4) NOT NULL,
  `unit_price` decimal(25,4) NOT NULL,
...
-- Dumping structure for table caudex.tec_sessions
...
-- Dumping structure for table caudex.tec_settings
...
-- Dumping structure for table caudex.tec_stores
...
-- Dumping structure for table caudex.tec_sub_categories
...
-- Dumping structure for table caudex.tec_suppliers
...
-- Dumping structure for table caudex.tec_suspended_items
...
-- Dumping structure for table caudex.tec_suspended_sales
...
-- Dumping structure for table caudex.tec_uom
...
-- Dumping structure for table caudex.tec_users
...
-- Dumping structure for table caudex.tec_user_logins
