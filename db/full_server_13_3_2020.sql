...
-- Dumping structure for table caudex_vat.tec_brand
...
-- Dumping structure for table caudex_vat.tec_country
...
-- Dumping structure for table caudex_vat.tec_items_returns
...
) ENGINE=InnoDB AUTO_INCREMENT=32200 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tec_uom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5207 DEFAULT CHARSET=latin1;
