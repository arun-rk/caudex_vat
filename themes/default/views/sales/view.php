...
<div style="grid-area:free"></div> -->
	...
	if ($store) {
			...
			echo " <div class='align_center' style='grid-area:r_header'><span class='semi_text'> RETURN ITEMS </span></div>";
...
<div  class="sales_person tiny_text" style='grid-area:sales_person'><?= lang("Customer","Customer").': '.$customer->name?></div>
