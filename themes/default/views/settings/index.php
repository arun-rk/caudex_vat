                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
								  ...
								  <div class="form-group">
                                    <?= lang('Sale Margin %', 'Sale Margin %'); ?>
                                    <?= form_input('sale_margin', $settings->sale_margin, 'class="form-control tip" id="sale_margin" required="required"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="well well-sm">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls"> <?php
                                            $decimals = array(0 => lang('disable'), 1 => '1', 2 => '2', 3 => '3');
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls"> <?php
                                            $qty_decimals = array(0 => lang('disable'), 1 => '1', 2 => '2', 3 => '3');
                                    ...
                                    <div class="well well-sm">
                                        ...
                                        <div class="col-md-12">
										  ...
										  <?= lang('Patient', 'Patient'); ?>
                                                <?php $ed = array('0' => lang('disable'), '1' => lang('enable')); ?>
                                                <?= form_dropdown('patient', $ed, $Settings->patient, 'class="form-control select2" id="patient" '); ?>
										  ...
										  <?= lang('Doctor', 'Doctor'); ?>
                                                <?php $ed = array('0' => lang('disable'), '1' => lang('enable')); ?>
                                                <?= form_dropdown('doctor', $ed, $Settings->doctor, 'class="form-control select2" id="doctor" '); ?>
											   </div>
                                        </div>
