                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
								...
								<div class="form-group">
                                    <?= lang('HSN', 'HSN'); ?>
                                    <?= form_input('hsn', $product->hsncode, 'class="form-control tip" id="hsn"  required="required"'); ?>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_dropdown('category', $cat, $product->category_id, 'class="form-control select2 tip" id="category"  required="required"'); ?>
																...
																<div class="form-group">
                                    <?= lang('Unit of measure', 'uom_id'); ?>
                                    <?php
																		$catx= getMfield('id,base_name','tec_uom');
																		$items= array(''=>'Choose Unit of measure');
																		foreach ($catx as  $value) {
																			$items[$value['id']] = $value['base_name'];
																		}
																		if(!set_value('uom_id')){
																			$xxz = $product->uom_id;
																		}
																		else{
																			$xxz = set_value('uom_id');
																		}
                                    ?>
                                    <?= form_dropdown('uom_id', $items,$xxz, 'class="form-control select2 tip" id="uom_id"  required="required" style="width:100%;"'); ?>
                                </div>
 <div class="form-group">
                                    ...
                                    <?= form_dropdown('gst_groups', $cat2, $product->gst_id, 'class="form-control select2 tip" id="gst_groups"  required="required"'); ?>
                                </div>
  ...
  <div class="form-group st">
                                    ...
                                    <?= form_input('price_margin', $product->price_margin, 'class="form-control tip" id="price_margin"'); ?>
                                </div>
                                <div class="form-group">
                                    <?= lang('price', 'price'); ?>
                                ...
                                <div class="form-group st">
                                 ...
                                 <select class="form-control select2" name="supplier_id" id="supplier_id">
                                    ...
                                    <?php LoadCombo("tec_suppliers","id","name",$product->supplier_id,'',"order by name asc"); ?>
                                 </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="st">
                                    ...
                                    <div class="form-group">
                                        <?= lang('pkg_qty', 'pkg_qty'); ?>
                                        <?= form_input('pkg_qty', set_value('pkg_qty',$this->tec->formatQuantity(@$product->pkg_qty)), 'class="form-control tip" id="quantity"'); ?>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
        ...
        ?>
		 ...
		 $(document).on('change', '#cost', function () {
			...
			if($("#cost").val().trim()!='' && $("#price_margin").val().trim()=='')
			{
				...
				$("#price").val((Number($("#cost").val())+PercentageAmt).toFixed(2));
