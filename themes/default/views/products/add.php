                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                    <?= lang('HSN', 'HSN');  ?>
                                    <?= form_input('hsn', set_value('hsncode'), 'class="form-control tip" id="code"  '); ?>
                                </div>
                                ...
                                <div class="form-group st">
                                 ...
                                 <select class="form-control select2" name="supplier_id" id="supplier_id">
                                    ...
                                    <?php LoadCombo("tec_suppliers","id","name",'','',"order by name asc"); ?>
                                 </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <div class="well well-sm">
                                        <h4><?= cryptography($store->name).' ('.cryptography($store->code).')'; ?></h4>
                                        <div class="form-group st">
                                ...
                                <div class="st">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?= form_input('pkg_qty', set_value('pkg_qty', 0), 'class="form-control tip" id="pkg_qty" required="required"'); ?>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
