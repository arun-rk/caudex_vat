...
<script type="text/javascript">
 ...
 function applyfilter(apply_filter) {
	 ...
	 table.ajax.reload(function () {
			...
			$(apply_filter).text('Filter Products');
	   });
 }
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="col-xs-1"><input type="text" class="text_filter" placeholder="[<?= lang('code'); ?>]"></th>
								 <th class="col-xs-1"><input type="text" class="text_filter" placeholder="[<?= lang('HSN'); ?>]"></th>
