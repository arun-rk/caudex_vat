...
<div class="wrapper rtl rtl-inv">
    ...
    <header class="main-header">
        <a href="<?= site_url(); ?>" class="logo">
            <?php if ($store) { ?>
            <span class="logo-mini"><?php echo cryptography($store->code); ?></span>
		...
		<input type="hidden" value="<?= $Settings->sale_margin; ?>" id="salesPerc" />
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview mm_products">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li id="products_print_barcodes"><a href="<?= site_url('products/print_barcodes_2'); ?>"  ><i class="fa fa-circle-o"></i> <?= lang('print_barcodes_2'); ?></a></li>
                ...
                <li class="treeview mm_subcategories">
                    <a href="<?= site_url('subcategories'); ?>">
                        <i class="fa fa-folder"></i>
                        <span><?= lang('Sub categories'); ?></span>
                ...
                <li class="treeview mm_settings">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="divider"></li>
                       <li id="settings_index"><a href="<?= site_url('uom'); ?>"><i class="fa fa-circle-o"></i> <?= lang('UOM'); ?></a></li>
                        <li class="divider"></li>
