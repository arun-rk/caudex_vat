...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#SLRData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('reports/dayily_gst/'. $v);?>', type: 'POST', "data": function ( d ) {
                                ...
                                <table id="SLRData" class="table table-striped table-bordered table-condensed table-hover">
                                    <thead>
                                        ...
                                        <tr class="active">
											...
											<th class="col-sm-2"><?= lang("Bill No"); ?></th>
                                 ...
                                 <tfoot>
                                        <tr class="active">
                                            <th class="col-sm-2 text-center"><?= lang('Date'); ?></th>
                                            <th class="col-sm-2 text-center"><?= lang('Bill No'); ?></th>
                                                                
                                            <th class="col-sm-2 text-center"><?= lang("GST %"); ?></th>
                                            <th class="col-sm-1 text-center"><?= lang("Sales"); ?></th>
