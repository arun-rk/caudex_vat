                        ...
                        <div class="calendar table-responsive">
                            ...
                            <table class="table table-bordered" style="min-width:522px;">
                                ...
                                <tr>
                                    <?php
                                    if (!empty($sales)) {
																			// <span style='font-weight:normal;'>".lang('product_tax').
																			// "<br><span style='float:right;'>{$this->tec->formatMoney($value->product_tax)}</span><br>".lang('order_tax').
																			// "<br><span style='float:right;'>{$this->tec->formatMoney($value->order_tax)}</span></span>
                                        foreach ($sales as $value) {
                                            ...
                                            $array[$value->date] = "<table class='table table-condensed table-striped table-calendar' style='margin-bottom:0;'><tr><td style='text-align:left;font-weight:bold;'>".lang('total').
																						...
																						"<br><span style='float:right;font-weight:bold;'>{$this->tec->formatMoney($value->total)}</span></td>
																						</tr><tr><td style='text-align:left;font-weight:bold;'><br><span style='font-weight:bold;'>".lang('tax')."</span>".
