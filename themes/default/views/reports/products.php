...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#PrRData').DataTable({
            ...
            'columnDefs': [
               { className: 'text-right', targets: [0,1,2,3,4,5] }
            //    { className: 'text-left!important', targets: [1] }
            ],

            "buttons": [
            { extend: 'copyHtml5', 'footer': true, exportOptions: { columns: [  1, 2, 3, 4, 5] } },
            { extend: 'excelHtml5', 'footer': true, exportOptions: { columns: [  1, 2, 3, 4, 5] } },
            { extend: 'csvHtml5', 'footer': true, exportOptions: { columns: [  1, 2, 3, 4, 5 ] } },
