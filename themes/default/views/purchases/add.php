												 ...
												 <!-- <th class="col-xs-2"><?= lang('SGST %'); ?></th>
												  <th class="col-xs-2"><?= lang('Tax'); ?></th> -->
												   <th class="col-xs-2"><?= lang('Vat %'); ?></th>
												    ...
												    <th class="col-xs-2"><?= lang('Expiry Date'); ?></ths>
    ...
    var row = $(this).closest('tr');
        ...
        function add_product_item(item, noitem) {
            ...
            $.each(items, function () {
                ...
                // tr_html += '<td><input class="form-control text-center expiry_date" name="expiry_date[]" type="text" value="" data-id="' + row_no + '" data-item="' + item.id + '" id="combo_item_price_' + row_no + '"  ></td>';
