									...
									<tbody>
                                        ...
                                        foreach ($rows as $row) {
											...
											if($row->tax_method == "0"){
												...
												echo $this->tec->formatMoney(($row->net_unit_price + ($row->item_tax / $row->quantity))-($row->cgst_tax_val+$row->sgst_tax_val)) . '</td>';
											}
											else{
										...
										<tr>
											...
											<th colspan="2" style="text-align:right;"><?= $this->tec->formatMoney($inv->product_discount); ?>
											</th>
										</tr>
										<tr>
											<th colspan="7" style="text-align:left;"><?= lang("Order Discount :"); ?></th>
											<th colspan="2" style="text-align:right;"><?= $this->tec->formatMoney($inv->order_discount); ?>
											</th>
										</tr>
										<?php
										 echo '<tr style="display:none"><th colspan="7" style="text-align:left;>' . lang("SGST :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($SGST) . '</th></tr>';
										   echo '<tr style="display:none"><th colspan="7" style="text-align:left;">' . lang("CGST :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($CGST). '</th></tr>';
											 echo '<tr><th colspan="7" style="text-align:left;">' . lang("VAT :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($CGST+$SGST). '</th></tr>';
										...
										<tr>
											...
											<th colspan="2" style="text-align:right;">
												<?= $this->tec->formatMoney($inv->grand_total - $inv->paid); ?></th>
										</tr>
										<?php } ?>
									</tbody>
