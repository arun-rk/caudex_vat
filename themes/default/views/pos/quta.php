                    ...
                    <div id="receiptData" style="width: auto; max-width: 90%; min-width: 90%; margin: 0 auto;">
                            ...
                            <div>
                                ...
                                <p class="P_Left" style="padding: 0px !important;margin: 0px !important;">
								 <?= lang("GSTIN","GSTIN").': '.$Settings->gstin; ?> <br>
                                    ...
                                    <?= lang('Quotations No','Quotations No').': '.$inv->id; ?><br>
                                ...
                                <table class="table table-striped table-condensed" border="1" style="margin-bottom:0px !important">
                                    ...
                                    <tbody>
									 <tr>
                                        ...
                                        <?php
										 echo '<tr><th colspan="9" style="text-align:left;">' . lang("GST :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($inv->total_tax) . '</th></tr>';
										   if ($inv->order_tax != 0) {
                        ...
                        <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                            ...
                            <span class="col-xs-12">
                                   <a class="btn btn-block btn-warning" href="<?= site_url('sales/quotation'); ?>"><?= lang("Back to Quotations"); ?></a>
                            </span>
                            <?php } ?>
                            <div style="clear:both;"></div>
                        </div>
