                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview mm_sales">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li id="sales_return_index"><a href="<?= site_url('sales/returns'); ?>"><i class="fa fa-circle-o"></i> <?= lang('List Sales Returns'); ?></a></li>
                               </ul>
                        </li>
                        ...
                        <li class="treeview mm_settings">
                            ...
                            <ul class="treeview-menu">
                                <li id="settings_index"><a href="<?= site_url('settings'); ?>"><i class="fa fa-circle-o"></i> <?= lang('settings'); ?></a></li>
                                 <li class="divider"></li>
						<li id="settings_index"><a href="<?= site_url('gst'); ?>"><i class="fa fa-circle-o"></i> <?= lang('GST'); ?></a></li>
                        <li class="divider"></li>
                        ...
                        <li class="treeview mm_reports">
							...
							<li id="reports_gst"><a href="<?= site_url('reports/gst'); ?>"><i class="fa fa-circle-o"></i> <?= lang('GST'); ?></a></li>
                                ...
                                <div class="well well-sm" id="leftdiv">
                                    <div id="lefttop" style="margin-bottom:5px;">
                                        ...
                                        <div class="form-group" style="margin-bottom:5px;">
										   ...
										   <div class="form-group" style="margin-bottom:5px;">
                                            <input type="text" name="gstno" value="" id="gstno" class="form-control kb-text" placeholder="<?=lang('GST No')?>" />
                                        </div>
                                    ...
                                    <div id="botbuttons" class="col-xs-12 text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4" style="padding: 0;">
											  <div class="btn-group-vertical btn-block">
                                                <button type="button" class="btn btn-success btn-block btn-flat" id="<?= $eid ? 'submit-sale' : 'payment'; ?>" ><?= $eid ? lang('submit') : lang('payment'); ?>
												</button>
												 <button type="button" class="btn btn-warning btn-block btn-flat"
                                                    id="Quotation"><?= lang('Quotation'); ?></button>
													 </div>
                                            </div>
                                        </div>
