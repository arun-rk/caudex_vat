...
.semi_text {
	...
	if ($store) {
			...
			echo " <div class='align_center' style='grid-area:r_header'><span class='semi_text'> DAY CLOSE </span></div>";
...
<div class="ar-no-printx" >
                ...
                <div class="form-group ar-no-printx">
