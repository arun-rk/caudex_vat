    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                ?>
                <div id="wrapper">
                    <div id="receiptData" style="width: auto; max-width: 650px; min-width: 250px; margin: 0 auto;">
                        <div class="no-print">
                            <?php if ($message) { ?>
                        ...
                        <div id="receipt-data">
                            <div>
								   ...
								   <div class="P_Right">
									 ...
									 <?php if ($Settings->doctor==1 ) { ?>
                                        <div class="form-group" style="margin-bottom:5px;">
                                            <?= lang("Doctor Name").': '. $inv->doctor; ?> <br>
                                        </div>
                                        <?php } ?>
										 <?php if ($Settings->patient==1 ) { ?>
                                        <div class="form-group" style="margin-bottom:5px;">
                                              <?= lang("Patient Name").': '. $inv->patient; ?> <br>
                                        </div>
                                        <?php } else {?>
                                ...
                                <table class="table table-striped table-condensed">
                                    <thead>
                                        <tr>
                                            <th style="text-align:center; width: 30%; border-bottom: 2px solid #ddd;"><?=lang('Item');?></th>
											<th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('HSN Code');?></th>
											<th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('price');?></th>
                                            <th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('quantity');?></th>
                                            <th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('CGST %');?></th>
											 <th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('Tax');?></th>
											  <th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('SGST %');?></th>
											   <th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('Tax');?></th>
                                            <th style="text-align:center; width: 10%; border-bottom: 2px solid #ddd;"><?=lang('subtotal');?></th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($rows as $row) {
                                            echo '<tr><td style="text-align:left;">' . $row->product_name .'</td>';
											  echo '<td style="text-align:center;">' . $row->hsn . '</td>';
											...
											echo '<td style="text-align:center;">' . $row->cgst_tax .'</td>';
											echo '<td style="text-align:center;">' . $row->cgst_tax_val .'</td>';
											echo '<td style="text-align:center;">' . $row->sgst_tax .'</td>';
											echo '<td style="text-align:center;">' . $row->sgst_tax_val .'</td>';
                                    ...
                                    <tfoot>
                                        ...
                                        <?php
										 echo '<tr><th colspan="7" style="text-align:left;">' . lang("GST :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($inv->total_tax) . '</th></tr>';
										   if ($inv->order_tax != 0) {
