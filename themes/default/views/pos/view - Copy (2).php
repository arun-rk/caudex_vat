                        ...
                        <div id="receipt-data">
                            <div>
                                <div style="text-align:center;">
                                    ...
                                    if ($store) {
                                     //   echo '<img src="'.base_url('uploads/'.$store->logo).'" alt="'.$store->name.'">';
                                        ...
                                        echo '<strong style="font-size: 25px;">'.$store->name.'</strong><br>';
                                ...
                                <p class="P_Left" style="padding: 0px !important;margin: 0px !important;">
								 <?= lang("GSTIN","GSTIN").': '.$Settings->gstin; ?> <br>
                                ...
                                <div style="float:right;">   <?= lang("date","date").': '.$this->tec->hrld($inv->date); ?> </div><br>
                                    ...
                                    <?= lang("sales_person","sales_person").': '. $created_by->first_name." ".$created_by->last_name; ?> <br>
                                </div>
								...
								<?= lang("GST No","GST No").': '. $inv->gstno; ?> <br>  
                                ...
                                <table class="table table-striped table-condensed" border="1" style="margin-bottom:0px !important">
                                    ...
                                    <tbody>
									 <tr>
										<th style="text-align:center; width: 5%; border-bottom: 2px solid #000;"><?=lang('Sl No');?></th>
                                            <th style="text-align:center; width: 30%; border-bottom: 2px solid #000;"><?=lang('Item');?></th>
											<th style="text-align:center; width:7%; border-bottom: 2px solid #000;"><?=lang('HSN Code');?></th>
											<th style="text-align:center; width: 9%; border-bottom: 2px solid #000;"><?=lang('price');?></th>
                                            <th style="text-align:center; width: 7%; border-bottom: 2px solid #000;"><?=lang('quantity');?></th>
											  <th style="text-align:center; width: 7%; border-bottom: 2px solid #000;"><?=lang('Discount');?></th>
                                            <th style="text-align:center; width: 7%; border-bottom: 2px solid #000;"><?=lang('CGST %');?></th>
											 <th style="text-align:center; width: 7%; border-bottom: 2px solid #000;"><?=lang('Tax');?></th>
											  <th style="text-align:center; width: 7%; border-bottom: 2px solid #000;"><?=lang('SGST %');?></th>
											   <th style="text-align:center; width: 6%; border-bottom: 2px solid #000;"><?=lang('Tax');?></th>
                                            <th style="text-align:center; width: 15%; border-bottom: 2px solid #000;"><?=lang('subtotal');?></th>
                                        ...
                                        foreach ($rows as $row) {
                                            echo '<tr id="ItemsRow"><td id="ItemsList" style="text-align:center;">' . $SlNo.'</td>';
											   echo '<td  id="ItemsList"  style="text-align:left;">' . $row->product_name .'</td>';
											  echo '<td  id="ItemsList"  style="text-align:center;">' . $row->hsn . '</td>';
											...
											echo '<td  id="ItemsList"  style="text-align:center;">' . $row->cgst_tax .'</td>';
											echo '<td  id="ItemsList"  style="text-align:center;">' . $row->cgst_tax_val .'</td>';
											echo '<td  id="ItemsList" style="text-align:center;">' . $row->sgst_tax .'</td>';
											echo '<td  id="ItemsList"  style="text-align:center;">' . $row->sgst_tax_val .'</td>';
                                        ...
                                        ?>
										 <tr>
                                            <th colspan="9" style="text-align:left;"><?= lang("Total :"); ?></th>
                                            <th colspan="2" style="text-align:right;"><?= $this->tec->formatMoney($inv->total ); ?></th>
                                        </tr>
										  <tr>
                                                <th colspan="9" style="text-align:left;"><?= lang("Product Discount :"); ?></th>
                                                <th colspan="2" style="text-align:right;"><?= $this->tec->formatMoney($inv->product_discount); ?></th>
                                            </tr>
											  <tr>
                                                <th colspan="9" style="text-align:left;"><?= lang("Order Discount :"); ?></th>
                                                <th colspan="2" style="text-align:right;"><?= $this->tec->formatMoney($inv->order_discount); ?></th>
                                            </tr>
                                        <?php
										 echo '<tr><th colspan="9" style="text-align:left;">' . lang("SGST :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($SGST) . '</th></tr>';
										   echo '<tr><th colspan="9" style="text-align:left;">' . lang("CGST :") . '</th><th colspan="2" style="text-align:right;">' . $this->tec->formatMoney($CGST). '</th></tr>';
										 if ($inv->order_tax != 0) {
                                        ...
                                        if ($Settings->rounding) {
                                            ...
                                            <tr>
                                                <th colspan="9" style="text-align:left;"><?= lang("Grand Total :"); ?></th>
                                            ...
                                            ?>
                                            <tr>
                                                <th colspan="9" style="text-align:left;"><?= lang("grand_total"); ?></th>
                                        ...
                                        <tr>
                                            <th colspan="9" style="text-align:left;"><?= lang("paid_amount"); ?></th>
                                            <th colspan="2" style="text-align:right;"><?= $this->tec->formatMoney($inv->paid); ?></th>
                                        </tr>
                                        <tr>
                                            <th colspan="9" style="text-align:left;"><?= lang("due_amount"); ?></th>
