...
function loadItems() {
	...
	if (get('spositems')) {
		...
		$.each(spositems, function () {
			...
			tr_html += '<td class="text-right price"><input class="realuprice" name="real_unit_price[]" type="hidden" value="' + realitemprice + '"><input class="rdiscount" name="product_discount[]" type="hidden" id="discount_' + row_no + '" value="' + ds + '"><span class="text-right sprice" id="sprice_' + row_no + '">' + formatMoney(parseFloat(net_price2)) + '</span></td>';
			...
			tr_html += '<td class="text-right discount"><span class="text-right discount" id="discount_' + row_no + '">' + formatMoney(product_discount_item) + '</span></td>';
			...
			tr_html += '<td class="text-right cgst-tax" style="display:none"><span class="text-right ssubtotal" id="cgst_value_' + row_no + '">' + formatMoney(((parseFloat(net_price) * parseFloat(item_qty)) * parseFloat(item.gst.cgst)) / 100) + '</span></td>';
			...
			tr_html += '<td class="text-right sgst-tax" style="display:none"><span class="text-right ssubtotal" id="sgst_value_' + row_no + '">' + formatMoney(((parseFloat(net_price) * parseFloat(item_qty)) * parseFloat(item.gst.sgst)) / 100) + '</span></td>';
...
taxamnt=formatMoney(parseFloat(taxamnt)*2);

tr_html += '<td class="text-right vat"><span class="text-right ssubtotal" id="cgst_tax_' + row_no + '">' + vat + '</span></td>';
tr_html += '<td class="text-right vat-tax"><span class="text-right ssubtotal" id="cgst_value_' + row_no + '">' + taxamnt + '</span></td>';


			if (item_tax_method == 0) {

				tr_html += '<td class="text-right subtotal"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney((parseFloat(net_price))) + '</span></td>';
			} else {

				tr_html += '<td class="text-right subtotal"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney((parseFloat(net_price) * parseFloat(item_qty)) + (((parseFloat(net_price) * parseFloat(item_qty)) * parseFloat(item.gst.cgst)) / 100) + (((parseFloat(net_price) * parseFloat(item_qty)) * parseFloat(item.gst.sgst)) / 100)) + '</span></td>';
			}
