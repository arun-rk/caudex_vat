...
function loadItems() {
    ...
    if (get('spositems')) {
        ...
        $.each(spositems, function () {
            ...
            tr_html += '<td class="text-right price"><input class="realuprice" name="real_unit_price[]" type="hidden" value="' + item.row.real_unit_price + '"><input class="rdiscount" name="product_discount[]" type="hidden" id="discount_' + row_no + '" value="' + ds + '"><span class="text-right sprice" id="sprice_' + row_no + '">' + formatMoney(parseFloat(net_price) ) + '</span></td>';
    ...
    tr_html += '<td class="text-right discount"><span class="text-right discount" id="discount_' + row_no + '">' + formatMoney(product_discount )+ '</span></td>';
              
  tr_html += '<td class="text-right cgst"><span class="text-right ssubtotal" id="cgst_tax_' + row_no + '">' + item.gst.cgst + '</span></td>';
            tr_html += '<td class="text-right cgst-tax"><span class="text-right ssubtotal" id="cgst_value_' + row_no + '">' + formatMoney(((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.cgst))/100)+ '</span></td>';
            tr_html += '<td class="text-right sgst"><span class="text-right ssubtotal" id="cgst_tax_' + row_no + '">' + item.gst.sgst + '</span></td>';
            tr_html += '<td class="text-right sgst-tax"><span class="text-right ssubtotal" id="sgst_value_' + row_no + '">' +formatMoney(((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.sgst))/100)+  '</span></td>';
		  ...
		  tr_html += '<td class="text-right subtotal"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney((parseFloat(net_price)  * parseFloat(item_qty)) + (((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.cgst))/100)+(((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.sgst))/100))+ '</span></td>';
            ...
            total += formatDecimal((parseFloat(net_price)) * parseFloat(item_qty));
