  ...
  tr_html += '<td class="text-right cgst"><span class="text-right ssubtotal" id="cgst_tax_' + row_no + '">' + item.gst.cgst + '</span></td>';
		  ...
		  tr_html += '<td class="text-right subtotal"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney((parseFloat(net_price)  * parseFloat(item_qty)) + (((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.cgst))/100)+(((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.sgst))/100))+ '</span></td>';
            ...
            total += formatDecimal((parseFloat(net_price)) * parseFloat(item_qty));
			   gst += formatDecimal((((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.cgst))/100)+(((parseFloat(net_price)* parseFloat(item_qty))* parseFloat(item.gst.sgst))/100));
